...
class OMAPS2Sampler(object):
    def __init__(self, hdf5s_dir, segment_seconds, hop_seconds, 
            batch_size, mini_data, random_seed=1234):
        """Sampler is used to sample segments for training or evaluation.
        ...
        self.batch_size = batch_size
        self.random_state = np.random.RandomState(random_seed)
        split = os.path.basename(hdf5s_dir)
...
class OMAPS2TestSampler(object):
    def __init__(self, hdf5s_dir, segment_seconds, hop_seconds, 
            batch_size, mini_data, random_seed=1234):
        """Sampler for testing.
